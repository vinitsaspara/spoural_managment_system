    ...
    >
      ...
      <div className="relative h-48 w-full overflow-hidden">
        ...
        <div className="absolute top-4 right-4 z-20">
          <Badge className="bg-white/90 text-blue-600 px-4 py-1.5 rounded-full text-sm font-medium backdrop-blur-sm group-hover:bg-white transition-all duration-300">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="flex-grow">
          <h1 className="font-bold text-lg mb-2 text-gray-800 group-hover:text-blue-600 transition-colors duration-300">
            {game?.gameName}
          </h1>
        ...
        >
          ...
          <Button 
            ...
            onClick={() => navigate(`/createPracticeSchedule/${game?._id}`)}
          >
            <span>Add Practice Schedule</span>
